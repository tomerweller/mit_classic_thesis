...
The Webapp is currently stored on Heroku, a pupular platform service that makes it very simple to deploy new versions and scale up and down. However, the usage of open standards and technologies make it possible to migrate to other services or dedicated hardware. 
